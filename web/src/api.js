...
export const api = {
  ...
  inspectAdminLogin: () => request('POST', '/admin/login/inspect'),
  refreshAdminLogin: () => request('POST', '/admin/login/refresh'),
  analyzeAdminLogin: () => request('POST', '/admin/login/analyze'),
  cancelAdminLogin: () => request('POST', '/admin/login/cancel'),
  logoutAdmin: () => request('POST', '/admin/logout'),
  getScreenshots: (limit = 60) => request('GET', `/screenshots?limit=${limit}`),
